      ...
      <section class="py-24 flex flex-col items-center justify-center">
        <div class="mx-auto max-w-[43rem]">
          <div class="text-center ">
            <h1 class="mt-1 text-[3.0rem] font-bold leading-[4rem] tracking-tight text-white">NBA Predict</h1>
            <p class="text-xl font-medium leading-8 text-gray-400">NBA Predict is a website that utilizes a neural network to predict the outcome of NBA games. We use 42-48 unique data points and 10 years of historic data to predict the outcome.</p>
          </div>
